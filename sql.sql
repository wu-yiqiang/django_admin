...
values (1, '查询用户列表', 1, '/user/page','2024-07-04', '2024-07-04', '查询用户列表', 0),
       ...
       (6, '查询角色列表',1,'/role/page', '2024-07-04', '2024-07-04', '查询角色列表', 0),
       (7, '添加角色',2,'/role/create', '2024-07-04', '2024-07-04', '添加角色', 0),
       (8, '删除角色',3,'/role/delete', '2024-07-04', '2024-07-04', '删除角色', 0),
       (9, '编辑角色',2,'/role/edit', '2024-07-04', '2024-07-04', '编辑角色', 0),
       (10, '查询角色详情',1,'/role/detail', '2024-07-04', '2024-07-04', '查询角色详情', 0);
