...
insert into `menu` (`id`, `name`, `icon`, `parent_id`, `order_num`, `path`, `menu_type`, `code`,
                        `create_time`, `update_time`, `remark`, `is_deleted`)
values (1, '个人中心', 'personal', 0, 1, '/personal', '2', 'personal', '2024-07-04', '2024-07-04', '个人中心菜单', 0),
       (2, '系统管理', 'settings', 0, 2, '/settings', '1', 'settings', '2024-07-04', '2024-07-04', '系统管理目录', 0),
       (3, '用户管理', 'users', 1, 1, '/settings/users', '2', 'users', '2024-07-04', '2024-07-04',
        '用户管理菜单', 0),
       (4, '角色管理', 'roles', 1, 2, '/settings/roles', '2', 'roles', '2024-07-04',
        '2024-07-04', '角色管理菜单', 0),
       (5, '菜单管理', 'menus', 1, 3, '/settings/menus', '2', 'menus', '2024-07-04',
        '2024-07-04', '菜单管理菜单', 0),
        (6, '按钮管理', 'buttons', 1, 3, '/settings/buttons', '2', 'buttons', '2024-07-04',
        '2024-07-04', '按钮管理菜单', 0),
       (7, '数据管理', 'monitor', 0, 3, '/datas','1', 'datas', '2024-07-04', '2024-07-04', '数据管理目录', 0),
       (8, '部门管理', 'tree', 2, 1, '/datas/departments', '2', 'departments', '2024-07-04', '2024-07-04',
        '部门管理菜单', 0),
       (9, '岗位管理', 'post', 2, 2, '/datas/positions',  '2', 'positions', '2024-07-04', '2024-07-04', '岗位管理菜单', 0),
       (10, '公司管理', 'post', 2, 3, '/datas/companys', '2', 'companys', '2024-07-04', '2024-07-04', '公司管理菜单', 0);
